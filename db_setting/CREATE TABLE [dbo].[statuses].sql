...
ADD CONSTRAINT [DF_Table_1_book_status] DEFAULT ((0)) FOR [status_num]
GO

ALTER TABLE [dbo].[statuses]  
WITH CHECK ADD CONSTRAINT [FK_statuses_books] FOREIGN KEY([book_id])
...
ALTER TABLE [dbo].[statuses]  
WITH CHECK ADD CONSTRAINT [FK_statuses_employees] FOREIGN KEY([employee_number])
