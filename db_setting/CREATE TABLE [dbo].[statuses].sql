...
/****** Object:  Table [dbo].[statuses]    Script Date: 2024/03/09 11:19:17 ******/
SET ANSI_NULLS ON
GO
...
ALTER TABLE [dbo].[statuses] ADD  CONSTRAINT [DF_statuses_datetime]  DEFAULT (getdate()) FOR [update_datetime]
GO
